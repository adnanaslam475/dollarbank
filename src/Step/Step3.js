        ...
        <div>
            {check > 0 &&
                ...
                <div>
                    ...
                    <CustomView title="Everything Checking" detail="$50 initial deposit required"
                        value={true} buttonName="Buy Now" value1="Schedule an Appointment" 
            ...
            {check == 0 &&
                ...
                <div>
                    ...
                    <CustomView title="Free Checking"
                        detail="$50 initial deposit required" value={true} buttonName="Buy Now"
                        value1="Schedule an Appointment"
                        value2="Print Recommendation" />
